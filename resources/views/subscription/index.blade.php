                    ...
                    <div class="d-flex gap-2">
                        @if (\Auth::user()->customer->can('disableRecurring', $subscription))
                            <a link-method="POST" link-confirm="{{ trans('messages.subscription.disable_recurring.confirm') }}"
                                ...
                                class="btn btn-secondary black-btn"
                                style="width: 140px"
                            >
                                <i class="fa-solid fa-ban"></i>
                                <p>{{ trans('messages.subscription.disable_recurring') }}</p>
                            </a>
                        @endif
                        ...
                        @if (\Auth::user()->customer->can('enableRecurring', $subscription))
                            ...
                            >
                                ...
                                <p>{{ trans('messages.subscription.enable_recurring') }}</p>
                            </a>
                        @endif
                        ...
                        @if (\Auth::user()->customer->can('changePlan', $subscription))
                            <a
                                ...
                                class="btn btn-default change_plan_button edit-btn"
                                style="width: 140px"
                            >
                                <i class="fa-solid fa-ellipsis"></i>
                                <p>{{ trans('messages.subscription.change_plan') }}</p>
                            </a>
                        @endif
                        ...
                        @if (\Auth::user()->customer->can('cancelNow', $subscription))
                            ...
                            >
                                ...
                                <p>{{ trans('messages.subscription.cancel_now') }}</p>
                            </a>
                        @endif
                    </div>
                @endif
