        ...
        <div class="d-flex top-list-controls top-sticky-content">
                    ...
                    <div class="filter-box">
                        ...
                        <div class="dropdown list_actions me-3" style="display: none">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" link-confirm="{{ trans('messages.remove_blacklist_confirm') }}" href="{{ action('SenderController@delete') }}"><span class="material-symbols-rounded">delete_outline</span> {{ trans('messages.delete') }}</a></li>
                            </ul>
                        </div>
            ...
            <div class="">
                @if (Auth::user()->can('create', new Acelle\Model\Sender()))
                    <div class="text-end">
                        <a href="{{ action('SenderController@create') }}" role="button" class="btn btn-secondary add-btn">
                            <i class="fa-solid fa-plus"></i>
                            <p>{{ trans('messages.sender.create') }}</p>
                        </a>
                    </div>
                @endif
            </div>
