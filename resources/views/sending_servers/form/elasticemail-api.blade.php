...
@endif
    ...
    <div class="mc_section">
        <div class="row">
            <div class="col-md-6">
                <p>{!! trans('messages.sending_servers.elasticemail_api_key.intro') !!}</p>
...
<form action="{{ action('SendingServerController@config', $server->uid) }}" method="POST" class="form-validate-jqueryz">
    ...
    <div class="mc_section">
        <div class="row">
            <div class="col-md-6">
                ...
                <p>
                    {{ trans('messages.sending_servers.configuration_settings.elasticemail.intro') }}
                </p>
                ...
                <p>{!! trans('messages.sending_servers.sending_limit.elasticemail.intro') !!}</p>
    ...
    @include('sending_servers.form.elasticemail-sender-identity')
