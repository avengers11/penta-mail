                ...
                <td class="text-end pe-0">
                    <div class="d-flex align-items-center text-nowrap justify-content-end" role="group">
                        ...
                        <a href="{{ action('SubscriberController@create', $list->uid) }}" data-popup="tooltip"
                            title="{{ trans('messages.create_subscriber') }}" role="button" class="btn btn-secondary btn-icon me-1 add-btn">
                            <i class="fa-solid fa-user"></i>
                            <p>Add User</p>
                        </a>

                        <a href="{{ action('MailListController@overview', $list->uid) }}" role="button" class="btn btn-primary me-1 save-btn">
                            <i class="fa-solid fa-chart-pie"></i>
                            <p>{{ trans('messages.list.overview_statistics') }}</p>
                        </a>
                        <div class="btn-group" role="group">
                            <button id="btnGroupDrop1" type="button" class="btn btn-light btn-icon dropdown-toggle edit-btn"  data-bs-toggle="dropdown" aria-expanded="false">
