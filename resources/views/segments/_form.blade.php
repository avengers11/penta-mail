                    <div class="sub_section">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<br />
								<a sample-url="{{ action('SegmentController@sample_condition', $list->uid) }}" href="#add_condition" class="btn btn-info bg-teal-800 add-segment-condition add-btn" style="width: 120px">
									<i class="fa-solid fa-plus"></i>
                					<p>{{ trans('messages.add_condition') }}</p>
								</a>
