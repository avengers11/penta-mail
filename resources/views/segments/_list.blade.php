            ...
            <tr class="position-relative">
                ...
                <td>
                    ...
                    <span class="text-muted">{{ trans('messages.created_at') }}
                        : {{ Auth::user()->customer->formatDateTime($item->created_at, 'datetime_full') }}</span>
                </td>
                <td>
                ...
                <td class="text-end text-nowrap pe-0">
                    <div class="d-flex gap-2 justify-content-end">
                        @if (\Gate::allows('update', $item))
                            ...
                            role="button" class="btn edit-btn">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                @if (\Gate::allows('delete', $item))
                                    <li><a class="dropdown-item list-action-single" link-confirm="{{ trans('messages.delete_segments_confirm') }}" href="{{ action('SegmentController@delete', ['list_uid' => $list->uid, "uids" => $item->uid]) }}">
