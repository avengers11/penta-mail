...
@section('page_header')
    ...
    <div class="page-title">
        ...
        <h1>
            <span class="material-symbols-rounded">add</span> {{ trans('messages.form.create') }}</span>
        </h1>
    </div>
        ...
        <div class="row">
            <div class="col-md-12" style="position: relative;">
                <div class="d-flex align-items-center mt-4 template-create-sticky">
                    ...
                    <div class="text-left">
                        <a href="javascript:;" class="btn btn-secondary add-btn start-design">
                            <i class="fa-solid fa-plus"></i>
                            <p>{{ trans('messages.template.create_and_design') }}</p>
                        </a>
                    </div>
                </div>
