...
@section('page_header')
    ...
    <div class="page-title">				
        ...
        <h1>
            <span><span class="material-symbols-rounded">format_list_bulleted</span> {{ trans('messages.Automations') }}</span>
        </h1>				
    </div>
...
@section('content')
    ...
    >				
        <div class="d-flex top-list-controls top-sticky-content">
                ...
                <div class="filter-box">
                    ...
                    <div class="dropdown list_actions" style="display: none">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="dropdown-item" link-method="POST" link-confirm="{{ trans('messages.disable_automations_confirm') }}" href="{{ action('Automation2Controller@disable') }}">
                                    <span class="material-symbols-rounded me-2">hide_source</span> {{ trans('messages.disable') }}</a></li>
                            <li>
                                ...
                                <span class="material-symbols-rounded me-2">delete_outline</span> {{ trans('messages.delete') }}</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="text-end">
                <a href="{{ action("Automation2Controller@wizard") }}" role="button" class="btn btn-secondary create-automation2 add-btn">
                    <i class="fa-solid fa-plus"></i>
                    <p>{{ trans('messages.automation.create') }}</p>
                </a>
            </div>
        </div>
