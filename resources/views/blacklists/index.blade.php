...
@section('page_header')
    <div class="page-title">
        ...
        <h1>
            <span class="text-semibold"><span class="material-symbols-rounded">format_list_bulleted</span> {{ trans('messages.blacklist') }}</span>
        </h1>
    </div>
@endsection
        ...
        <div class="d-flex top-list-controls top-sticky-content">
                    ...
                    <div class="filter-box">
                        ...
                        <div class="dropdown list_actions me-3" style="display: none">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" link-confirm="{{ trans('messages.remove_blacklist_confirm') }}" href="{{ action('BlacklistController@delete') }}"><span class="material-symbols-rounded">delete_outline</span> {{ trans('messages.delete') }}</a></li>
                            </ul>
                        </div>
            ...
            <div class="">
                @if (Auth::user()->customer->can('import', new Acelle\Model\Blacklist()))
                    <div class="text-end">
                        <a href="{{ action('BlacklistController@import') }}" role="button" class="btn btn-secondary add-btn">
                            <i class="fa-solid fa-plus"></i>
                            <p>{{ trans('messages.blacklist.import') }}</p>
                        </a>
                    </div>
                @endif
            </div>
