...
@section('content')
    ...
    <div class="row mt-4 mb-4">
        <div class="col-md-3">
            <div class="bg-color1 bg-secondary p-3 shadow rounded-3 text-white">
                <div class="text-center">
                    <h2 class="text-light mb-1 mt-0">{{ number_with_delimiter($subscriberCount) }}</h2>
        ...
        <div class="col-md-3">
            <div class="bg-color2 bg-secondary p-3 shadow rounded-3 text-white">
                <div class="text-center">
                    <h2 class="text-light mb-1 mt-0">{{ number_to_percentage($activeContactPercent) }}</h2>
                    <div class="text-light text-white">
        ...
        <div class="col-md-3">
            <div class="bg-color3 bg-secondary p-3 shadow rounded-3 text-white">
                <div class="text-center">
                    <h2 class="text-light mb-1 mt-0">{{ number_with_delimiter($formCount) }}</h2>
                    <div class="text-light">
                        @if (Auth::user()->customer->forms()->count())
                            <p class="mb-0 text-light">{{ trans('messages.list.form.desc') }}</p>
                        @else
                            <p class="mb-0 text-light">{{ trans('messages.forms_not_yet') }}</p>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <a href="{{ action('BlacklistController@index') }}" class="bg-color4 bg-secondary p-3 shadow rounded-3 d-block">
                <div class="text-center">
                    <h2 class="text-light mb-1 mt-0">
                        {{ number_with_delimiter($blacklistedCount) }}
                    </h2>
                    <div class="text-light">
                        <p class="mb-0 text-light">{!! trans('messages.list.blacklist.desc') !!}</p>                        
                    </div>
                </div>
            </a>
        </div>
    ...
    <h3 class="mt-5 mb-20"><span class="material-symbols-rounded me-2">insights</span> {{ trans('messages.audience.audience_growth.title') }}</h3>
    ...
    <h3 class="mt-5 mb-20"><span class="material-symbols-rounded me-2">open_in_new</span> {{ trans('messages.audience.quick_action') }}</h3>
        ...
        <div class="quick-action-items">
            <div class="quick-action py-3 border-top">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-auto">
                        <a href="{{ action('FormController@index') }}" class="btn add-btn">
                            <i class="fa-solid fa-plus"></i>
                            <p>{{ trans('messages.form.create') }}</p>
                        </a>
                    </div>
                </div>
            </div>
            <div class="quick-action py-3 border-top">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-auto">
                        <a href="javascript:;" class="btn btn-primary import-select-list edit-btn">
                            <i class="fa-solid fa-plus"></i>
                            <p>{{ trans('messages.audience.import_contacts.title') }}</p>
                        </a>
                    </div>
                </div>
            </div>
