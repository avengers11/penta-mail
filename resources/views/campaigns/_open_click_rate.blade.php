    ...
    <div class="col-md-6">
        ...
        <div class="stat-table">
            ...
            <div class="stat-row">
                ...
                <span class="pull-right num">
                    {{ $campaign->lastOpen() ? Auth::user()->customer->formatDateTime($campaign->lastOpen()->created_at, 'datetime_full') : "" }}
                </span>
            </div>
        </div>
        <div class="text-end">
            <a href="{{ action('CampaignController@openLog', $campaign->uid) }}" class="btn btn-info bg-teal-600 add-btn" style="width: 86px">
                <i class="fa-solid fa-ellipsis"></i>
                <p>{{ trans('messages.open_log') }}</p>
            </a>
        </div>
        <br />
    </div>
    <div class="col-md-6">
        ...
        <div class="stat-table">
            ...
            <div class="stat-row">
                ...
                <span class="pull-right num">
                    {{ $campaign->lastClick() ? Auth::user()->customer->formatDateTime($campaign->lastClick()->created_at, 'datetime_full') : "" }}
                </span>
            </div>
        </div>
        <div class="text-end">
            <a href="{{ action('CampaignController@clickLog', $campaign->uid) }}" class="btn btn-info bg-teal-600 add-btn" style="width: 86px"> 
                <i class="fa-solid fa-ellipsis"></i>
                <p>{{ trans('messages.click_log') }}</p>
            </a>
        </div>
        <br />
    </div>
