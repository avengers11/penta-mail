    ...
    <div class="col-md-8">
        <ul class="modern-listing big-icon no-top-border-list mt-0">
            @foreach (Acelle\Model\Campaign::types() as $key => $type)
                ...
                <li>
                    <a href="{{ action("CampaignController@create", ["type" => $key]) }}" class="btn btn-secondary save-btn">
        ...
        <div class="">
            <a href="{{ action('CampaignController@index') }}" role="button" class="btn btn-secondary delete-btn" style="width: 80px">
