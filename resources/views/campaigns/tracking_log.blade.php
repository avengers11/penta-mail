...
<h2 class="text-semibold text-primary">{{ trans('messages.tracking_log') }}</h2>
...
<form class="listing-form"
    ...
    >
        <div class="d-flex top-list-controls top-sticky-content">
            ...
            <div class="text-end">
                <a href="javascript:goToDownLoad('tracking_logs')" role="button" class="btn btn-secondary save-btn">
                    <i class="fa-solid fa-circle-down"></i>
                    <p>{{ trans('messages.tracking_log.download') }}</p>
                </a>
            </div>
        </div>
    ...
    <script>
        var CampaignLogIndex = {
            getList: function() {
                return makeList({
                    url: '{{ action('CampaignController@trackingLogListing', $campaign->uid) }}',
