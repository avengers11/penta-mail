        ...
        <div class="d-flex align-items-center">
            <div>
                <h1 class="d-flex align-items-center">
                    <span class="material-symbols-rounded me-3">format_list_bulleted</span> <span class="text-semibold">{{ trans('messages.templates') }}</span>
                </h1> 
            </div>
            <div class="ms-auto pt-5">                
        ...
        <div class="d-flex top-list-controls top-sticky-content">
            ...
            <div class="text-end d-flex align-items-center ms-auto">
                ...
                <div class="d-flex gap-1">
                    <a href="{{ action('TemplateController@uploadTemplate') }}" class="btn btn-light edit-btn">
                        <i class="fa-solid fa-plus"></i>
                        <p>{{ trans('messages.upload') }}</p>
                    </a>  
                    <a href="{{ action('TemplateController@builderCreate') }}" class="btn btn-secondary add-btn">
                        <i class="fa-solid fa-plus"></i>
                        <p>{{ trans('messages.create') }}</p>
                    </a>
